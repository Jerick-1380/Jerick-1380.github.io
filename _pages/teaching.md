...
<div class="timeline">
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      ...
      <ul>
        ...
        <li>TA for Algorithm Design & Analysis</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2025 Summer</h4>
      <ul>
        <li>TA for AwesomeMath Summer Program</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2025 Spring</h4>
      <ul>
        <li>TA for Intro to Math Finance</li>
        <li>TA for Intro to ML (SCS Majors)</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2024 Fall</h4>
      <ul>
        <li>TA for Differential Equations</li>
        <li>TA for Intro to ML (SCS Majors)</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2024 Spring</h4>
      <ul>
        <li>TA for Continuous Time Finance</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2023 Fall</h4>
      <ul>
        <li>Peer Tutor for Great Ideas in CS</li>
        <li>TA for Differential Equations</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2023 Spring</h4>
      <ul>
        <li>Peer Tutor for Math Concepts & Functional Programming</li>
        <li>TA for Differential Equations</li>
      </ul>
    </div>
  </div>
  ...
  <div class="timeline-item">
    ...
    <div class="timeline-content">
      <h4>2022 Summer</h4>
      <ul>
        <li>Co-Instructor for Blissful Coding Club</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm-12 col-md-6 mt-3">
    <div class="embed-responsive embed-responsive-16by9">
      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/-Gx4Lk8ty8A" allowfullscreen></iframe>
    </div>
  </div>
  <div class="col-sm-12 col-md-6 mt-3">
    <div class="embed-responsive embed-responsive-16by9">
      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/OXCMPsYgwlA" allowfullscreen></iframe>
    </div>
  </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm-12 col-md-6 mt-3 offset-md-3">
    <div class="embed-responsive embed-responsive-16by9">
      <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/7U3DWSdyV0s" allowfullscreen></iframe>
    </div>
  </div>
</div>
